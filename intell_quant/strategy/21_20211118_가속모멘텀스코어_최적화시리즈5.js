...
function initialize() {
    ...
    account2 = IQAccount.addAccount('0000-0000-02', '2. 자산배분+모멘텀스코어', IQEnvironment.aum);
    basket2 = new Basket(account2, stock_num, IQEnvironment.aum * stock_weight);
    account3 = IQAccount.addAccount('0000-0000-03', '3. 가속모멘텀', IQEnvironment.aum);
...
function onDayClose(now) {
    if (IQDate.isRebalancingDay(now) || isFirst === true) {
        ...
        Port_Control(basket3, account3, port_value, AccelMomWeight, valueWeightRatio2, 1, 1, 1, 1, 1, 1, 1);
